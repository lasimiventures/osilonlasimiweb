...
export function RequestQuote() {
    ...
    return (
      <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          ...
          <p className="text-slate-500 mb-2 max-w-lg mx-auto">
            Thank you for your interest. Our sales team will review your request and send a detailed quotation within 24 business hours.
          </p>
          <p className="text-sm font-mono font-semibold text-blue-600 mb-8 bg-blue-50 inline-block px-4 py-2 rounded-lg">
            Reference: {quoteNumber}
          </p>
          <div className="flex flex-wrap items-center justify-center gap-4">
            <button
              onClick={() => { clearQuote(); navigate('/products'); }}
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (quoteErr || !quoteData) {
      setSubmitError(quoteErr?.message ?? 'Failed to submit your quote. Please try again.');
      setSubmitting(false);
      return;
    }
    ...
    if (items.length > 0) {
      ...
      if (itemsErr) {
        setSubmitError('Quote was saved but items could not be attached. Please contact us with your reference.');
      }
    }
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              <form onSubmit={handleSubmit} className="bg-white border border-slate-100 rounded-xl p-6 lg:p-8">
                ...
                {submitError && (
                  <div className="flex items-start gap-3 bg-red-50 border border-red-200 rounded-lg p-4 text-red-700 text-sm mb-4">
                ...
                <div className="flex items-center gap-3">
                  <button
                    type="submit"
                    disabled={submitting}
                    className="flex items-center gap-2 px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 disabled:opacity-60 transition-colors"
                  >
